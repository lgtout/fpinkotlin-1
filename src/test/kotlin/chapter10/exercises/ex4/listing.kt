...
class Exercise4 : WordSpec({
    ...
    val intGen = choose(-10000, 10000)

    "law of associativity" should {
        "be upheld using existing monoids" {
            monoidLaws(intAdditionMonoid, intGen) (max, count, rng) shouldBe Passed

            monoidLaws(intMultiplicationMonoid, intGen) (max, count, rng) shouldBe Passed
        }
    }
})
//end::init2[]
